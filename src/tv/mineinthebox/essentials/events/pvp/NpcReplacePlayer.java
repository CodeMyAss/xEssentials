...
public class NpcReplacePlayer implements Listener {
	
	public HashMap<String, String> essentialsPlayers = new HashMap<String, String>();
	public HashMap<UUID, ItemStack[]> npcs = new HashMap<UUID, ItemStack[]>();
