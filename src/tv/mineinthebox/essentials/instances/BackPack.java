...
public class BackPack extends ItemStack {
	...
	public Inventory getBackPack() {
		Inventory inv = Bukkit.createInventory(null, 36, ChatColor.DARK_GRAY + "Backpack:");
	...
	private int getFixedSize() {
		int i = 0;
		for(ItemStack a : getBackPack().getContents()) {
			if(a instanceof ItemStack && a.getType() != Material.AIR) {
				i++;
			}
		}
		return i;
